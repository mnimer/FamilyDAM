...
package com.mikenimer.familydam.filehandlers.images.jobs.music;
...
public class ID3Job implements JobConsumer
{
    ...
    private Map<String, Object> extractMetadata(Node node) throws RepositoryException, IOException, InterruptedException
    {
