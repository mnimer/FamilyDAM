angular.module('dashboard.templates', ['modules/main/main.tpl.html', 'modules/photos/photos.tpl.html', 'modules/user/preferences/preferences.tpl.html', 'modules/user/usermanager/usermanager.tpl.html']);
...
angular.module("modules/main/main.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/main/main.tpl.html",
    ...
    "                    <li ng-class=\"{ active: activePath=='/photos' }\">\n" +
    "                        <a href=\"#/photos\"><i class=\"icon-bar-chart\"></i><span class=\"hidden-sm\"> Photos</span></a>\n" +
    "                    </li>\n" +
    ...
    "\n" +
    "        <!-- start: Content -->\n" +
    "        <div class=\"primaryView\" ng-class=\"{'col-xs-12':!ModeFullScreen, 'col-sm-8':!ModeFullScreen, 'col-xs-12': ModeFullScreen}\" >\n" +
    "            <div ui-view></div>\n" +
    "        </div>\n" +
    "        <!-- end: Content -->\n" +
    "\n" +
...
angular.module("modules/photos/photos.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/photos/photos.tpl.html",
    "<div class=\"photos section col-sm-12\">\n" +
    "    <div id=\"toolbar\">\n" +
    "        <span>/Photos</span>\n" +
    "\n" +
    "        <span class=\"pull-right\">\n" +
    "            <a class=\"glyphicon glyphicon-list btn btn-default btn-sm\" ng-class=\"{active: layout == 'list'}\" ng-click=\"layout = 'list'\"></a>\n" +
    "            &nbsp;\n" +
    "            <a class=\"glyphicon glyphicon-th btn btn-default btn-sm\" ng-class=\"{active: layout == 'grid'}\" ng-click=\"layout = 'grid'\"></a>\n" +
    "        </span>\n" +
    "    </div>\n" +
    "\n" +
    "    <div class=\"content\">\n" +
