...
package com.mikenimer.familydam.filehandlers.videos.observers;

import com.mikenimer.familydam.filehandlers.videos.Constants;
import com.mikenimer.familydam.filehandlers.videos.MimeTypeManager;
        ...
        while (events.hasNext())
        {
            ...
            try
            {
                if (event.getType() == Event.NODE_ADDED || event.getType() == Event.NODE_MOVED)
                {
                    ...
                    if (MimeTypeManager.isMovie(event.getPath()))
                    {
